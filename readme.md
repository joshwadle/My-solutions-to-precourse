...
You will submitting your solutions with a git [pull request](https://help.github.com/articles/using-pull-requests). Here are step by step instructions of how to do this:
...
3. Run this command to create a copy of the repository on your computer: `git clone https://github.com/<your username>/precourse`
4. Create a directory called "solutions" and add your files to the solutions folder
5. Run this command to add your files to the repository: `git add solutions`
6. Run this command to commit your changes: `git commit -M "My solutions to precourse"`
7. Run this command to push your changes to your fork: `git push origin master`
8. Make a pull request by going to https://github.com/zipfian/precourse and clicking "Pull Requests" and then "New Pull Request"
